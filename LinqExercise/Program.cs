...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            numbers.Where(x => x > 6).ToList()
                .ForEach(Console.WriteLine);
            Console.WriteLine("=========================");

            //TODO: Order numbers in any order (acsending or desc) but only print 4 of them **foreach loop only!**
            numbers.OrderBy(x => x).Take(4).ToList()
                .ForEach(Console.WriteLine);
            Console.WriteLine("============================");

            //TODO: Change the value at index 4 to your age, then print the numbers in decsending order
            numbers.Select((x, i) => i == 4 ? 32 : x)
            ...
            var sumAverage = employees.Where(x => x.YearsOfExperience <= 10 && x.Age > 35).ToList();
             Console.WriteLine($"Sum of YOE : {sumAverage.Sum(x=> x.YearsOfExperience)}\nAverage YOE: {sumAverage.Average(x=> x.YearsOfExperience)}");
            Console.WriteLine("==================");
            //TODO: Add an employee to the end of the list without using employees.Add()
            employees = employees.Append(new Employee("Ron", "Pearlman", 72, 55)).ToList();
